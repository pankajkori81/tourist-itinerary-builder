...
export default function TransportForm({ 
  ...
  // --- UPDATED HANDLER: Auto-fill Description & Logistics ---
  const handleVehicleChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
      const newType = e.target.value;
      const srmMatch = availableSrmVehicles.find(t => t.vehicleType === newType);
      ...
      setFormData(prev => {
          if (srmMatch) {
              // If SRM match found, auto-fill ALL configured fields
              return { 
                  ...prev, 
                  vehicleType: newType,
                  ...
                  // 2. Map Logistics (Use SRM defaults if they exist, otherwise keep what user typed)
              ...
              // If switching to a standard vehicle (not in SRM), just reset price
              return { 
                  ...prev, 
                  vehicleType: newType,
                  price: 0 
